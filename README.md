# tp3 banque avec interface javafx
...
```
cd existing_repo
git remote add origin https://git.dti.crosemont.quebec/2250485/tp3-banque-avec-interface-javafx.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.dti.crosemont.quebec/2250485/tp3-banque-avec-interface-javafx/-/settings/integrations)
